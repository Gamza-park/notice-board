...
<body>
	<%
		...
		if(userID == null) {
			...
			script.println("alert('You need a Sign In!')");
		...
		<div class="row">
			<form method="post" action="updateAction.jsp?bbsID=<%= bbsID %>">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
					<thead>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; text-align: center;">Notice Board Fix Form</th>
						</tr>
					</thead>
					<tbody>
						<tr>
				...
				<input type="submit" class="btn btn-primary pull-right" value="Modified">
			</form>
