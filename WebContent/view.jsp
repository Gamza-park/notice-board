	...
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
				<thead>
					<tr>
						<th colspan="3" style="background-color: #eeeeee; text-align: center;">View the Content</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td style="wodth: 20%;">Title is</td>
			...
			<a href="bbs.jsp" class="btn btn-primary">Back to the List</a>
			<%	
				if(userID != null && userID.equals(bbs.getUserID())) {
			%>
				<a href="update.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">Modified</a>
				<a onClick="return confirm('You Want Delete this Content?')" href="deleteAction.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">Delete</a>
			<%
				}
			%>		
		</div>
